...
// Load Customer Management Module
if (file_exists(plugin_dir_path(__FILE__) . "modules/customer-management.php")) {
    require_once plugin_dir_path(__FILE__) . "modules/customer-management.php";
}
